...
// // //         <div>
// // //           <h1 className={`${styles.heroHeadText} text-yellow-100`}>
// // //             Hi, I'm <span className='text-[#915EFF]'>Shubham</span>
// // //           </h1>
// // //           <p className={`${styles.heroSubText} mt-2 text-white-100`}>
// // //             Welcome to my digital space. <br className='sm:block hidden' />
// // //             Explore my journey, projects, and passion for building meaningful web experiences.
// // //           </p>
// // //         </div>
// // //       </div>
...
// // import { styles } from "../styles";
// // import { ComputersCanvas } from "./canvas";
// // import { spline } from "../assets/index"; // Importing the spline URL from assets
...
// //             Hi, I'm <span className=' text-yellow-400 text-shadow-gold uppercase italic font-serif'>Shubham</span>
// //           </h1>
